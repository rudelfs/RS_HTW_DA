export default function TaskSetting({ t, onNext }) {
  return (
    <div className="bg-white border-4 border-charcoal p-6 md:p-10 shadow-diy max-w-2xl mx-auto animate-window-pop">
      <h2 className="text-2xl md:text-3xl font-black mb-6 uppercase tracking-tighter">
        {t?.ts_title || "Ihre Aufgabe"}
      </h2>
      <p className="text-lg md:text-xl text-slate-700 leading-relaxed font-medium mb-8">
        {t?.ts_text || "Willkommen zu dieser kurzen Studie. Stellen Sie sich vor, Sie haben es eilig und müssen sofort wissen, ob Sie morgen in Berlin einen Regenschirm brauchen. Bitte finden Sie im folgenden simulierten Browserfenster so schnell wie möglich heraus, wie das Wetter morgen wird."}
      </p>
